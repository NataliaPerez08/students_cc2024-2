...
\begin{enumerate}
    ...
    Synchronized bloquea la llamada al método del siguiente subproceso mientras no haya finalizado la ejecución del subproceso anterior.
    Los hilos pueden acceder a este método de uno en uno. Sin synchronized todos los hilos pueden acceder a este método simultáneamente.
